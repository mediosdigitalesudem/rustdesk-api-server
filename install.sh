1. add in https://github.com/infiniteremote/rustdesk-api-server/blob/master/README_EN.md#method-2-run-the-code
2. create service
[Unit]
...
[Service]
ExecStart=<your_virtualenv_directory>/bin/python <your_project_directory>/manage.py runserver 0.0.0.0:21114
